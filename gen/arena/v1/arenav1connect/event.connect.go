...
const (
	...
	EventServiceName = "arena.v1.EventService"
)
...
const (
	...
	EventServiceListEventsProcedure = "/arena.v1.EventService/ListEvents"
)

// EventServiceClient is a client for the arena.v1.EventService service.
type EventServiceClient interface {
	ListEvents(context.Context, *connect.Request[v1.ListEventsRequest]) (*connect.Response[v1.ListEventsResponse], error)
}

// NewEventServiceClient constructs a client for the arena.v1.EventService service. By default, it
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_arena_v1_event_proto.Services().ByName("EventService").Methods()
...
// ListEvents calls arena.v1.EventService.ListEvents.
...
// EventServiceHandler is an implementation of the arena.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/arena.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) ListEvents(context.Context, *connect.Request[v1.ListEventsRequest]) (*connect.Response[v1.ListEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("arena.v1.EventService.ListEvents is not implemented"))
}
